...
function HeroGeometric() {
  return (
    <div id="home" className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303] font-sdrobotics">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 min-h-screen flex items-center">
        <div className="flex flex-col md:flex-row min-h-screen w-full">
          {/* Left content */}
          <div className="flex-1 p-4 md:p-8 flex flex-col justify-center " style={{ fontFamily: 'Sdrobotics' }}>
            <h1 className="text-4xl md:text-5xl font-bold font-sdrobotics bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
              Hey human it&apos;s Indrani 
            </h1>
            <p className="text-md mt-4 text-neutral-300 max-w-lg text-wrap md:text-nowrap" style={{ fontFamily: 'Sdrobotics' }}>
              Fullstack Developer | Part Human, Part Code | Trained on Coffee & JavaScript ☕⚙️
            </p>
          </div>
